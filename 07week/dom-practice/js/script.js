...
function itemAlert(){
  let list = document.getElementsByTagName("ul");
  alert("there are " + listCount() + " items in your cart");
}
...
function insertItemCounter(){
  ...
  newh2.innerHTML = "You have " + listCount + " items in your cart";
...
function updateItemCounter(){
  ...
  document.getElementsByTagName("ul")[0].children.length + " items in your cart";
}
